...
- ![](https://img.shields.io/github/stars/MukundaKatta/ai-eval-forge?style=social&label=github.com) [**AI Eval Forge**](https://github.com/MukundaKatta/ai-eval-forge) - Mixed-check regression testing for LLM and agent workflows. Combines deterministic checks, rubric-style review, and artifact tracking. Preprint: [Zenodo](https://doi.org/10.5281/zenodo.20044318).
...
- ![](https://img.shields.io/github/stars/MukundaKatta/agent-stack?style=social&label=github.com) [**Agent Stack**](https://github.com/MukundaKatta/agent-stack) - Five small npm libraries for AI agent reliability: tool-arg validation, network egress firewall, snapshot tests for tool-call traces, token-aware truncation, and structured output with retry. Zero deps. Writeup: [DEV.to](https://dev.to/mukundakatta/i-built-5-tiny-libraries-to-stop-my-ai-agents-from-misbehaving-in-production-3oni).
