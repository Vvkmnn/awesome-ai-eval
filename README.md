...
- ![](https://img.shields.io/github/stars/KarmaEnchanter/mental-health-llm-eval?style=social&label=github.com) [**Mental Health LLM Eval**](https://github.com/KarmaEnchanter/mental-health-llm-eval) - Five-rubric LLM safety eval for mental-health-adjacent prompts (empathy, clinical accuracy, harm avoidance, CBT alignment, crisis detection per 988 protocols). Inspect AI adapter, judge IRR via Cohen's quadratic-weighted kappa.
