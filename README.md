...
- ![](https://img.shields.io/github/stars/fastxyz/skill-optimizer?style=social&label=github.com) [**skill-optimizer**](https://github.com/fastxyz/skill-optimizer) - Benchmarks whether LLMs call the right tools from guidance docs; produces per-model PASS/FAIL scores for CI.
