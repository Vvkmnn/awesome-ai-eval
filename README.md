...
- ![](https://img.shields.io/github/stars/latitude-dev/latitude-llm?style=social&label=github.com) [**Latitude**](https://github.com/latitude-dev/latitude-llm) - Open-source, MIT-licensed platform for improving production AI agents — observe traces, search semantically, and track recurring failures as issues.
