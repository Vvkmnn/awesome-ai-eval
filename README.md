...
- ![](https://img.shields.io/github/stars/labrat-akhona/semantix-ai?style=social&label=github.com) [**semantix-ai**](https://github.com/labrat-akhona/semantix-ai) - Local, deterministic semantic validation of LLM outputs via quantized NLI. Drop-in DSPy reward/metric, pytest assertions, tamper-evident hash-chained audit trail. No API calls, ~15 ms per check.
